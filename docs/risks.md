...
| R7 | Gün kaybı (İSG ve gezi planda; ek beklenmedik kesintiler) | Orta | Orta | Task 3.4, 4.4, 5.4 esnek tampon; eğitim koşuları geceye/paralele alınır | Herhangi bir blokta 1+ gün kayıp | 🟡 (Gün 2–3 biliniyor) |
